          ...
          <div className="sm:flex justify-center sm:space-x-4 mt-6 mx-4 space-y-4 sm:mx-0 sm:space-y-0">
            <div className="bg-blue-gray-200 sm:w-1/6 p-4 rounded-md">
              <div className="text-5xl">
                <UserIcon className="h-12 w-1 inline-block mb-2" />
                5M
              </div>
            ...
            <div className="bg-blue-gray-200 sm:w-1/6 p-4 rounded-md">
              <div className="text-5xl">
                <BookOpenIcon className="h-12 w-12 inline-block mb-2" />
                30K
              </div>
              <p>30,000 Courses</p>
            </div>
            <div className="bg-blue-gray-200 sm:w-1/6 p-4 rounded-md">
              <div className="text-5xl">
                <Square3Stack3DIcon className="h-12 w-12 inline-block mb-2" />
                20K
              </div>
