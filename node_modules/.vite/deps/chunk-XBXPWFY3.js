import {
  NoSsr_default
} from "./chunk-J4L7YMBA.js";
import {
  Typography_default
} from "./chunk-XKEP5P6N.js";
import {
  Popper_default,
  useThemeProps
} from "./chunk-Q5NSGYCP.js";
import {
  useTheme
} from "./chunk-ALQZVXCI.js";
import {
  shouldForwardProp
} from "./chunk-I7GQPDO4.js";
import {
  styled_default
} from "./chunk-LYYG4YVI.js";
import {
  init_esm,
  init_ownerWindow,
  init_useControlled,
...
var useAnimatedPath = (path2, skipAnimation2) => {
  ...
  const interpolator = React19.useMemo(() => previousPath ? string_default(previousPath, path2) : () => path2, [previousPath, path2]);
  const {
    value
  } = useSpring({
    from: {
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime13.jsxs)(React30.Fragment, {
...
var ColorContext = React33.createContext({});
if (true) {
...
function ColorProvider(props) {
  ...
  return (0, import_jsx_runtime16.jsx)(ColorContext.Provider, {
...
var useDefaultizeAxis = (inXAxis, inYAxis) => {
  const xAxis = React38.useMemo(() => defaultizeAxis(inXAxis, "x"), [inXAxis]);
  const yAxis = React38.useMemo(() => defaultizeAxis(inYAxis, "y"), [inYAxis]);
  return [xAxis, yAxis];
};
...
var ChartContainer = React39.forwardRef(function ChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime18.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime18.jsx)(ColorProvider, _extends({}, colorProviderProps, {
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  const displayError = React40.useRef(false);
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime25.jsxs)(React48.Fragment, {
...
function useColorProcessor(seriesType) {
  const colorProcessors = React51.useContext(ColorContext);
  if (!seriesType) {
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime34.jsxs)(React60.Fragment, {
...
var LineChart = React71.forwardRef(function LineChart2(props, ref) {
  const {
    chartContainerProps,
    axisClickHandlerProps,
    gridProps,
...
//# sourceMappingURL=chunk-XBXPWFY3.js.map
